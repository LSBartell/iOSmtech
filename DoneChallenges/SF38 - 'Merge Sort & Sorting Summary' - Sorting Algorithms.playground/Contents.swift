...
/*
 ...
 they use sub arrays so it is easier to read, they also utilize divide and conquer which is more effective for parallel merge sort algorathims
 
 We need to learn about sorting algorithms so that...
 learn to solve unique problems and gain familiarity with how arrays and algorithms work
