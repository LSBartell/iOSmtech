 ...
 */
var runningChallenges = ["Run 1 mile at 18 degree slope", "Sprint a 50 yard dash"]
var chinUpChallenges = ["Do 8 chin ups", "Hang for 3 minutes"]
...
var challenges = [runningChallenges, chinUpChallenges]
...
var commitedChalleges = ["Run 1 mile twice a week"]

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
if commitedChalleges.isEmpty {
    print("Please commit a challenge")
} else if commitedChalleges.count == 1 {
    print("The challenge you have chosen is \(commitedChalleges[0])")
} else {
