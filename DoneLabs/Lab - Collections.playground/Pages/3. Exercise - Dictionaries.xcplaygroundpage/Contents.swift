...
if let january = daysInMonth["January"] {
    print("January has \(january) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["Square", "Circle"]
var colorsArray = ["Blue", "Green"]
var shapeAndColor = ["Shapes": shapesArray, "Colors": colorsArray]
print(shapeAndColor)
...
if let color = shapeAndColor["Colors"] {
    print(color[1])
}
