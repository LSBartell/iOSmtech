...
let human1 = Human(name: "joe", age: 70)
let human2 = Human(name: "dudebro", age: 18)
...
let human3 = Human(name: "Bobby", age: 25)
let human4 = Human(name: "letto", age: 32)
let human5 = Human(name: "Nattie", age: 17)
...
if let jsonData = try? jsonEncoder.encode(human1) {
    if let jsoneString = String(data: jsonData, encoding: .utf8) {
        print(jsoneString)
    }
}
