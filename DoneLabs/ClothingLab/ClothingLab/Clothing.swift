...
let shirts: [Clothing] = [
    ...
    Clothing(name: "Long Sleeve", price: 19.99, size: "M", color: "Black"),
...
let pants: [Clothing] = [
    ...
    Clothing(name: "Corduroy", price: 49.99, size: "34", color: "Brown"),
    Clothing(name: "Linen", price: 39.99, size: "M", color: "Beige"),
